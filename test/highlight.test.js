...
const finalCaptureCases = [
  ...
  {
    name: "command names retain pattern text around quotes and asterisks",
  ...
  {
    name: "command names retain pattern text around quotes and question marks",
    source: "pre\"quoted\"mid?tail'quoted'end\n",
    captures: [
      [0, 3, "string.regexp"],
      [3, 4, "punctuation.delimiter"],
  ...
  {
    name: "command names retain pattern text around quotes and bracket expressions",
  ...
  {
    name: "commands after assignments retain pattern text around quotes and asterisks",
  ...
  {
    name: "commands after assignments retain pattern text around quotes and question marks",
    source: "name=value pre\"quoted\"mid?tail'quoted'end\n",
    captures: [
      [0, 4, "variable"],
      [4, 5, "operator"],
  ...
  {
    name: "commands after assignments retain pattern text around quotes and bracket expressions",
  ...
  {
    name: "command arguments retain pattern text around quotes and asterisks",
  ...
  {
    name: "command arguments retain pattern text around quotes and question marks",
    source: "echo pre\"quoted\"mid?tail'quoted'end\n",
    captures: [
      [0, 4, "function.call"],
      [5, 8, "string.regexp"],
  ...
  {
    name: "command arguments retain pattern text around quotes and bracket expressions",
  ...
  {
    name: "for word lists retain pattern text around quotes and asterisks",
  ...
  {
    name: "for word lists retain pattern text around quotes and question marks",
    source: "for item in pre\"quoted\"mid?tail'quoted'end; do :; done\n",
    captures: [
      [0, 3, "keyword"],
      [4, 8, "variable"],
  ...
  {
    name: "for word lists retain pattern text around quotes and bracket expressions",
  ...
  {
    name: "redirection filenames retain pattern text around quotes and asterisks",
  ...
  {
    name: "redirection filenames retain pattern text around quotes and question marks",
    source: "cat >pre\"quoted\"mid?tail'quoted'end\n",
    captures: [
      [0, 3, "function.call"],
      [4, 5, "operator"],
  ...
  {
    name: "redirection filenames retain pattern text around quotes and bracket expressions",
  ...
  {
    name: "multiple active markers share literal captures in one word",
  ...
  {
    name: "substitutions interrupt pattern literals without inheriting their captures",
  ...
  {
    name: "command patterns do not color neighboring plain arguments",
  ...
  {
    name: "patterns after assignments do not color neighboring plain arguments",
  ...
  {
    name: "argument patterns do not color preceding or following plain words",
  ...
  {
    name: "for patterns do not color preceding or following plain words",
  ...
  {
    name: "filename patterns do not color their command name",
    source: "cat >pre?tail\n",
    captures: [
      [0, 3, "function.call"],
      [4, 5, "operator"],
  ...
  {
    name: "pathname patterns after a slash retain their role outside the tilde user",
