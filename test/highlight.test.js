...
const finalCaptureCases = [
  ...
  {
    name: "ancestor-removed continuations separate comment text captures",
    source: 'echo "`a #x\\\nb\n`"\n',
    captures: [
      [0, 4, "function.call"],
      [5, 7, "punctuation.delimiter"],
      [7, 8, "function.call"],
      [9, 11, "comment"],
      [11, 13, "punctuation.special"],
      [13, 14, "comment"],
      [15, 17, "punctuation.delimiter"],
    ],
  },
  {
  ...
  {
    name: "continued command and argument keep parent captures around slash leaves",
    source: "pri\\\nntf va\\\nlue\n",
    captures: [
      [0, 3, "function.call"],
  ...
  {
    name: "continued reserved words keep keyword captures around slash leaves",
    source: "i\\\nf :; th\\\nen :; f\\\ni\n",
    captures: [
      [0, 1, "keyword"],
  ...
  {
    name: "continued IO digits retain number captures beside the slash leaf",
    source: ": 1\\\n2>out\n",
    captures: [
      [0, 1, "function.call"],
      [2, 3, "number"],
  ...
  {
    name: "continued parameter names retain variable captures around the slash leaf",
    source: `: \${va\\\nr}\n`,
    captures: [
      [0, 1, "function.call"],
      [2, 3, "variable"],
  ...
  {
    name: "continued dollar quote prefixes retain separate punctuation captures",
    source: ": $\\\n'abc'\n",
    captures: [
      [0, 1, "function.call"],
  ...
  {
    name: "unclassified numeric parameter digits remain uncaptured around a continuation",
    source: `: \${0\\\n0}\n`,
    captures: [
      [0, 1, "function.call"],
      [3, 4, "punctuation.bracket"],
  ...
  {
    name: "continued heredoc closing words retain label captures around a slash leaf",
    source: "cat <<EOF\nfoo\nEO\\\nF\n",
    captures: [
      [0, 3, "function.call"],
      [4, 6, "operator"],
